package de.fhpotsdam.unfolding.examplesForProcessing3_0.provider;
...
public class MBTilesMapApp extends PApplet {
	...
	public static void main(String[] args) {
		...
		PApplet.main(new String[] { "de.fhpotsdam.unfolding.examplesForProcessing3_0.provider.MBTilesMapApp" });
	}
}