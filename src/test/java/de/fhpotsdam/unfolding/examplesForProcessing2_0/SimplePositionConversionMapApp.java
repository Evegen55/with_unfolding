package de.fhpotsdam.unfolding.examplesForProcessing2_0;

import processing.core.PApplet;

import de.fhpotsdam.unfolding.UnfoldingMap;
import de.fhpotsdam.unfolding.examplesForProcessing2_0.marker.SimpleMarkerManagerApp;
...
public class SimplePositionConversionMapApp extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { "de.fhpotsdam.unfolding.examplesForProcessing2_0.SimplePositionConversionMapApp" });
	}
}
