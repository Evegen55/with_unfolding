package de.fhpotsdam.unfolding.examplesForProcessing2_0.events;
...
public class ComplexMapEventApp extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { "de.fhpotsdam.unfolding.examplesForProcessing2_0.ComplexMapEventApp" });
	}
}
