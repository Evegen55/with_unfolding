package de.fhpotsdam.unfolding.examplesForProcessing2_0.interaction.multitouch;
...
public class MultitouchMapExternalTuioApp extends PApplet implements TuioListener {
	...
	public static void main(String[] args) {
		String[] params = new String[] { "--present", "--bgcolor=#000000", "--hide-stop",
				"de.fhpotsdam.unfolding.examplesForProcessing2_0.interaction.multitouch.MultitouchMapExternalTuioApp" };
		PApplet.main(params);
	}
